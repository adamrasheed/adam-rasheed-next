...
// Query: *[_type == "caseStudy" && slug.current == $slug][0]{  _id,  title,  subtitle,  teaser,  slug,  mainImage {    ...,    metadata  },  description[]{  ...,  _type == "image" => {    "imageUrl": asset->url,    alt  }},}
export type CASE_STUDY_BY_SLUG_QUERYResult = {
  _id: string;
  title: string | null;
  subtitle: string | null;
  teaser: string | null;
...
export type HOST_SHELF_QUERYResult = {
  ingredients: Array<{
    _id: string;
    name: string | null;
    category: "bitters" | "fresh" | "liqueur" | "mixer" | "spirit" | "sweetener" | "vermouth-wine" | null;
    inStock: boolean | false;
  }>;
  cocktails: Array<{
    _id: string;
    name: string | null;
    requires: Array<string | null> | null;
    garnishes: Array<string | null> | null;
  }>;
};
